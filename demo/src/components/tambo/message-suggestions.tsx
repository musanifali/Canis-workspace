...
export interface MessageSuggestionsProps extends React.HTMLAttributes<HTMLDivElement> {
  ...
  /** Auto-generate suggestions after assistant messages (default: true) */
...
>(
  (
    ...
    const {
      ...
      isGenerating,
      error,
    } = useTamboSuggestions({ maxSuggestions, autoGenerate });
  ...
  return (
    ...
    >
      {suggestions.length > 0
        ...
        : // Skeleton chips ONLY while suggestions are being generated. When a
          // thread genuinely has none (e.g. a fresh workspace-creation screen),
          // render nothing instead of permanent pulsing "Placeholder" boxes.
          isGenerating
