...
export default function Home() {
  ...
  return (
    <TamboProvider
      ...
      userKey={userKey}
      // Without time context the model guesses the date (it said "June 2026"
      // in July) — the SDK ships a prebuilt helper for exactly this
      contextHelpers={{ userTime: currentTimeContextHelper }}
      // DeepSeek's thinking mode rejects the tool_choice the name generator
      // uses ("Thinking mode does not support this tool_choice" 400s)
